...
import io.github.imagineDevit.giwt.assertions.ShouldMatchs;
...
import static io.github.imagineDevit.giwt.assertions.ShouldMatchs.matching;
    ...
    void verify(TestCase<Void, Events> tc) {
        ...
        tc
                ...
                .and("""
                                ...
                                """, events -> events.shouldMatch(ShouldMatchs.<Events>all(
